...
import learnway.view.admin.dashboard.slider.SliderTransition;
...
public class MainForm extends JPanel {
    ...
    private JPanel createHeader() {
        ...
        cmdMenu = createButton(new FlatSVGIcon("learnway/resources/icon/menu.svg"));
        cmdUndo = createButton(new FlatSVGIcon("learnway/resources/icon/undo.svg"));
        cmdRedo = createButton(new FlatSVGIcon("learnway/resources/icon/redo.svg"));
        cmdRefresh = createButton(new FlatSVGIcon("learnway/resources/icon/refresh.svg"));
