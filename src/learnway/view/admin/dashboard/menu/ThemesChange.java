...
public class ThemesChange extends JPanel {
    ...
    private void init() {
        ...
        JButton buttonLight = new JButton(createIcon("learnway/resources/icon/light.svg"));
        JButton buttonDark = new JButton(createIcon("learnway/resources/icon/dark.svg"));
